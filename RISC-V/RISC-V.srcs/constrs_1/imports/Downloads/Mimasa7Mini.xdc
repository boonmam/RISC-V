...
#                                               Push Buttons                                                       #
####################################################################################################################
set_property -dict { PACKAGE_PIN "F5"   IOSTANDARD LVCMOS15    SLEW FAST} [get_ports { sw[0] }];                     # IO_L13P_T2_MRCC_35            Sch = SW1
set_property -dict { PACKAGE_PIN "J4"   IOSTANDARD LVCMOS15    SLEW FAST} [get_ports { sw[1] }];                     # IO_L19N_T3_VREF_35            Sch = SW2
set_property -dict { PACKAGE_PIN "M6"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { sw[2] }];                     # IO_L19P_T3_A10_D26_14         Sch = SW3
set_property -dict { PACKAGE_PIN "N6"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { rst }];                     # IO_L19N_T3_A09_D25_VREF_14    Sch = SW4
